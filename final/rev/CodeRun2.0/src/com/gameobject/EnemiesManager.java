...
public class EnemiesManager {
	...
	private BufferedImage bug5;
	private BufferedImage bug6;
	private BufferedImage bug7;
	private Random rand;
	...
	public EnemiesManager(MainCharacter mainCharacter) {
		...
		try {
			...
			URL b5 =MainCharacter.class.getResource("/com/data/bug5.png");
			bug5 = ImageIO.read(b5);
			URL b6 =MainCharacter.class.getResource("/com/data/bug6.png");
			bug6 = ImageIO.read(b6);
			URL b7 =MainCharacter.class.getResource("/com/data/bug7.png");
			bug7 = ImageIO.read(b7);
		} catch (IOException e) {
            e.printStackTrace();
        }
	...
	private Enemy createEnemy() {
		...
		if(type == 0) {
			...
			return new bug(mainCharacter, 950, bug5.getWidth() - 10, bug5.getHeight() - 10, bug5);
		}else if(type==5){
			return new bug(mainCharacter, 950, bug6.getWidth() - 10, bug6.getHeight() - 10, bug6);
		}else{
			return new bug(mainCharacter, 950, bug7.getWidth() - 10, bug7.getHeight() - 10, bug7);
		}
	}
